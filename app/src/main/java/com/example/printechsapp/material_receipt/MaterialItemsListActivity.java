...
public class MaterialItemsListActivity extends AppCompatActivity {
    private Activity activity = MaterialItemsListActivity.this;
    private RecyclerView recycler;
    private DatabaseQueryOrder db;
    ...
    private AdapterMaterialItems adapter = new AdapterMaterialItems();
    private AdapterMaterialItems adapterItems;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new DatabaseQueryOrder(getApplicationContext());
        ...
        recycler      = findViewById(R.id.recycler_materila_items);
        noData        = findViewById(R.id.no_data_item);
        search_layout = findViewById(R.id.search_layout);
        locSpinner    = findViewById(R.id.location_spinner);
        searchEdit    = findViewById(R.id.search_material_item);
    ...
    private void getSQLiteData(boolean isDataUpdated) {
        if (!TextUtils.isEmpty(timeMillies)){
            itemsArray = db.getMaterialItems(timeMillies, locationValue);
            adapterItems = new AdapterMaterialItems(itemsArray, activity);
    ...
    class AdapterMaterialItems extends RecyclerView.Adapter<AdapterMaterialItems.ViewHolder> implements Filterable {
        public ArrayList<ItemModel> arrayList = new ArrayList<>();
        public ArrayList<ItemModel> listTemp;
        private Context context;
        public AdapterMaterialItems(ArrayList<ItemModel> arrayList, Context context) {
            this.arrayList = arrayList;
            this.listTemp = arrayList;
            this.context = context;
        }
        public AdapterMaterialItems() {
        }
        @NonNull
        @Override
        public AdapterMaterialItems.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_layout,parent,false);
            return new ViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull AdapterMaterialItems.ViewHolder holder, final int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!TextUtils.isEmpty(orderID)){
                        itemMaxQTY           = db.singleItemQTY(model.getBarcode(), orderID);
                        totalScannedItemQTY  = db.scannedItemQTY(model.getBarcode(), orderID, timeMillies);
                    }
        ...
        if (!isError){
            ...
            if (itemMaxQTY != 0){
                ...
                if (totalScannedItemQTY <=  itemMaxQTY){
                    db.updateMaterialItem(co, column_id);
    ...
    private void updateTotalCountinDB(String timeMillies) {
        ...
        db.updateTotalQTYMaterial(co,timeMillies + "");
    }
}
